    ...
    return this.each( function() {
		...
		iframe.id='horst';
            ...
            if(opts.content_css_url) {
                css = "<link type='text/css' rel='stylesheet' href='" + opts.content_css_url + "' /><link type='text/css' rel='stylesheet' href='/css/style.css' />";
            }

            var doc = "<html><head>"+css+"</head><body class='frameBody' style='background-color:white;'>"+content+"</body></html>";
	     ...
	     iframe.contentWindow.document.execCommand('insertBrOnReturn', true, true);
