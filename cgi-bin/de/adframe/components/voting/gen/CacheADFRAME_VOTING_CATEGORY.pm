package CacheADFRAME_VOTING_CATEGORY;
1;
sub new
{
	my $class			= shift;
...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require C:\www\motox\cgi-bin\de\adframe\components\voting\gen::ClassADFRAME_VOTING_CATEGORY;
	my $dbclass = ClassADFRAME_VOTING_CATEGORY->new();
