...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require www::V6::cgi-bin::de::fbmx::gen::ClassADFRAME_VOTING;
	my $dbclass = ClassADFRAME_VOTING->new();
...
sub addMessage
{
	my $this	= shift;
	my $mess	= shift;
	$this->{message}.='ClassADFRAME_VOTING: '.$mess."\n";   
}
1;
