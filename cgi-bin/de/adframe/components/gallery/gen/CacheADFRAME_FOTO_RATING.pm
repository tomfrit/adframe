package CacheADFRAME_FOTO_RATING;
1;
sub new
{
	my $class			= shift;
...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require C:\www\V6\cgi-bin\de\adframe\components\gallery\gen::ClassADFRAME_FOTO_RATING;
	my $dbclass = ClassADFRAME_FOTO_RATING->new();
