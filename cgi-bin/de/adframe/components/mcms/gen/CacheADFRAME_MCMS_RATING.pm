package CacheADFRAME_MCMS_RATING;
1;
sub new
{
	my $class			= shift;
...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require C:\www\motox\cgi-bin\de\adframe\components\mcms\gen::ClassADFRAME_MCMS_RATING;
	my $dbclass = ClassADFRAME_MCMS_RATING->new();
