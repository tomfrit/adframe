package CacheADFRAME_USERCOMPANYBRAND;
1;
sub new
{
	my $class			= shift;
...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require de::adframe::components::company::gen::ClassADFRAME_USERCOMPANYBRAND;
	my $dbclass = ClassADFRAME_USERCOMPANYBRAND->new();
