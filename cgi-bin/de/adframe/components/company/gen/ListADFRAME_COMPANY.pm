...
$SQL_QUERY_COLS = 'ADFRAME_COMPANY_ID,ADFRAME_CHANNEL,AREA,ACCOUNT_NO,COMPANY,BRANCH,STREET,ZIPCODE,CITY,COUNTRY,EMAIL,FON,FAX,URL,BANK_ACCOUNTNAME,BANK_ACCOUNTNUMBER,BANK_INSTITUTE,BANK_CODE,SALES_TAX_ID,COMMENT,year(CR_DATE),month(CR_DATE),dayofmonth(CR_DATE),hour(CR_DATE),minute(CR_DATE),STATUS,IS_ACTIVE';
