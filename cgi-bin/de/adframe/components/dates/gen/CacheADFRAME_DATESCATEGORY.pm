package CacheADFRAME_DATESCATEGORY;
1;
sub new
{
	my $class			= shift;
...
sub dbInitById
{
	my $this	= shift;
	my $id		= shift;
	require C:\www\motox\cgi-bin\de\adframe\components\dates\gen::ClassADFRAME_DATESCATEGORY;
	my $dbclass = ClassADFRAME_DATESCATEGORY->new();
